...
For comparision with the CRC, we ran a reference survey through SurveyMonkey which was given to a random sample (N=611) from the company's paid pool of California participants.
